...
from shared.model.group_modules import *
from shared.model import resnet
from shared.model.cbam import CBAM
...
class KeyEncoder_DINOv2_v6(nn.Module):
    def __init__(self, dino_cfg=None):
        ...
        resnet_pretrained = dino_cfg.get("resnet_pretrained", True)
        network = resnet.resnet50(pretrained=resnet_pretrained)
        self.conv1 = network.conv1
        self.bn1 = network.bn1
        self.relu = network.relu  # 1/2, 64
        self.maxpool = network.maxpool
        ...
        self.network2 = resnet.Segmentor(dino_cfg=dino_cfg)
        dino_feat_dim = self.network2.dino_feat_dim

        self.fuse1 = resnet.Fuse(dino_feat_dim, 1024) # n = [8, 9, 10, 11]
        self.fuse2 = resnet.Fuse(dino_feat_dim, 512)
        self.fuse3 = resnet.Fuse(dino_feat_dim, 256)
