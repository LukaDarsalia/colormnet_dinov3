...
from shared.model.aggregate import aggregate
from shared.model.modules import *
from shared.model.memory_util import *

from shared.model.attention import LocalGatedPropagation
...
class ColorMNet(nn.Module):
    def __init__(self, config, model_path=None, map_location=None):
        ...
        self.key_encoder = KeyEncoder_DINOv2_v6(config.get('dino'))
